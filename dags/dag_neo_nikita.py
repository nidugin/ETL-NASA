...
with dag:
    producer = BashOperator(
        task_id="producer",
        bash_command="""python3 /home/airflow_usr/scripts/nikita/producer_nikita.py test neo {0}""".format(api_key),
    )
    ...
    consumer = BashOperator(
        task_id="consumer",
        bash_command="""spark-submit /home/airflow_usr/scripts/nikita/consumer_nikita.py test neo""",
    )
    ...
    base = BashOperator(
        task_id="base",
        bash_command="""spark-submit /home/airflow_usr/scripts/nikita/base_nikita.py test neo"""
    )
    ...
    neo = BashOperator(
        task_id="neo",
        bash_command="""spark-submit /home/airflow_usr/scripts/nikita/analytical_nikita.py test neo"""
    )

    neo_hazard = BashOperator(
        task_id="neo_hazard",
        bash_command="""spark-submit /home/airflow_usr/scripts/nikita/analytical_nikita.py test neo_hazard"""
    )

    v_neo_hazard_dashboard_5 = BashOperator(
        task_id="v_neo_hazard_dashboard_5",
        bash_command="""spark-submit /home/airflow_usr/scripts/nikita/analytical_nikita.py test v_neo_hazard_dashboard_5"""
    )

    producer >> wait_5_min >> consumer >> \
    is_empty_landing >> base >> is_empty_base >> \
    [neo, neo_hazard, v_neo_hazard_dashboard_5]
